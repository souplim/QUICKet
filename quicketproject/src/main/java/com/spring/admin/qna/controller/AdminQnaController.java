...
public class AdminQnaController {
	...
	public String adminQnaList(@ModelAttribute QnaVO qvo, Model model) {
		...
		// 리스트 조회
		List<QnaVO> adminQnaList = adminQnaService.adminQnaList(s_num);
	...
	public String adminQnaDetail(@ModelAttribute QnaVO qvo, Model model) {
	...
	public String adminQnaDelete(@ModelAttribute QnaVO qvo) throws Exception{
		...
		result = adminQnaService.adminQnaDelete(qvo.getQ_no());
