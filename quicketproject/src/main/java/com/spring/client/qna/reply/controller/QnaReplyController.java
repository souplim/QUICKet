...
public class QnaReplyController {
	...
	public List<QnaReplyVO> qnaReplyList(@PathVariable("q_no") Integer q_no) {
	...
	public String qnaReplyInsert(@RequestBody QnaReplyVO qrvo) throws Exception {	
	...
	public String replyUpdate(@PathVariable("q_r_no") int q_r_no, @RequestBody QnaReplyVO qrvo) throws Exception{	// 댓글 번호 추출해 내야함 
	...
	public String replyDelete(@PathVariable("q_r_no") int q_r_no) throws Exception{
